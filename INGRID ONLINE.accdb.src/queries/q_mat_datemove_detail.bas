dbMemo "SQL" ="SELECT mm.TX_ROWID, mm.TX_DIRECTION, IIf(mm.TX_DATEDELIVERY=#7/14/2024#,'1','0')"
    " AS TX_CODE_D, IIf(mm.TX_DATEEXECUTED=#7/14/2024#,'1','0') AS TX_CODE_R, mm.TX_A"
    ...
    "aterial_movement AS mm\015\012WHERE ((mm.TX_DATEDELIVERY = #7/14/2024# OR mm.TX_"
    "DATEEXECUTED = #7/14/2024#) )\015\012GROUP BY mm.TX_ROWID, mm.TX_DIRECTION, IIf("
    "mm.TX_DATEDELIVERY=#7/14/2024#,'1','0'), IIf(mm.TX_DATEEXECUTED=#7/14/2024#,'1',"
