dbMemo "SQL" ="SELECT mm.TX_ROWID, mm.TX_DIRECTION, IIf(mm.TX_DATEDELIVERY=#7/3/2025#,'1','0') "
    "AS TX_CODE_D, IIf(mm.TX_DATEEXECUTED=#7/3/2025#,'1','0') AS TX_CODE_R, mm.TX_ATT"
    ...
    "erial_movement AS mm\015\012WHERE ((mm.TX_DATEDELIVERY = #7/3/2025# OR mm.TX_DAT"
    "EEXECUTED = #7/3/2025#) )\015\012GROUP BY mm.TX_ROWID, mm.TX_DIRECTION, IIf(mm.T"
    "X_DATEDELIVERY=#7/3/2025#,'1','0'), IIf(mm.TX_DATEEXECUTED=#7/3/2025#,'1','0'), "
